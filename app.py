...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=5):
            ...
            with gr.Row():
                # Change show_download_button to show_download
                res_heatmap = gr.Image(label="Heatmap (Mức độ thay đổi)", elem_classes="result-image", show_download=True)
                res_overlay = gr.Image(label="Overlay (Vùng thay đổi)", elem_classes="result-image", show_download=True)
